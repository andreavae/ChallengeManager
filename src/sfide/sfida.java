...
public abstract class Sfida implements Comparable<Sfida> {
	...
	protected Orario orario; // partecipanti 
	protected String p1,p2;
	protected boolean campionato; // se false è amichevole 
	protected String ID;
	
	// costruttore con ID
	public Sfida(String ID, String descrizione, String p1, String p2, Orario o, boolean c) throws OrarioNonValidoException {
    this.ID = ID; 
    ...
    orario = o; campionato = c; // inc nSfide
    nSfide++; 
    
	}
	
	// tieni memoria di quante sfide ho cosrtuito 
	static int nSfide = 0; // costruttore senza ID
